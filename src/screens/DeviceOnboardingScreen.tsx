...
type DeviceOnboardingScreenProps = {
  navigation: StackNavigationProp<RootStackParamList, "DeviceOnboarding">
  setHasDevice: React.Dispatch<React.SetStateAction<boolean>>
}
...
const DeviceOnboardingScreen: React.FC<DeviceOnboardingScreenProps> = ({ navigation, setHasDevice }) => {
